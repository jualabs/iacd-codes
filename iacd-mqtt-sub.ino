...
void setup() {
  ...
  mqttclient.setCallback(callback); //a funcao "callback" será chamada quando um dado for enviado dado 
                                    //em algum tópico que este nodemcu estiver inscrito
  usrInit();
}
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (String(topic) == String(cfgTopic)){
