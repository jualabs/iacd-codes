...
/* definicoes para o sensor DHT-22 */
#define DHTPIN D3
...
void coletar_e_enviar_dados() {
  ...
  /* realiza a leitura da umidade (a leitura leva 250 ms) */
  float h = dht.readHumidity();
  /* realiza a leitura da temperatura (a leitura leva 250 ms) */
  float t = dht.readTemperature();
  /* verifica se as leituras foram corretas, caso contrario retorna da funcao para tentar novamente */
  if (isnan(h) || isnan(t)) {
